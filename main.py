...
print("🚀 [System] 문자열 잘림 완벽 방어! 10코어 엔진 재가동!")
    ...
    for update in response["result"]:
        ...
        if cmd == "/상태":
            ...
            if not current_tracked_names:
                ...
                sorted_items.sort()
                send_message("📂 전체 목록 (총 " + str(len(sorted_items)) + "개)")
...
if __name__ == "__main__":
    ...
    send_message("🤖 본진+네이버 10코어 초고속 감시망 가동!")
    ...
    while True:
        ...
        if cycle_count > 1:
            ...
            if new_ids:
                ...
                for i in range(0, len(new_list), 30):
                    ...
                    msg = "\n".join([str(idx+1) + ". " + n for idx, n in enumerate(chunk)])
        ...
        print("⏳ " + str(cycle_count) + "회차 완료. 7초 대기...")
        for _ in range(7):
            check_commands()
            time.sleep(1)
